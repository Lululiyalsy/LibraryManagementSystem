...
void ReaderWindow::setupCentralWidget()
{
    ...
    QAction *bookSearchAction = new QAction(QIcon(":/image/book.png"), "图书查询", this);
    QAction *myBorrowAction = new QAction(QIcon(":/image/borrow.png"), "我的借阅", this);
    QAction *myReservationAction = new QAction(QIcon(":/image/reservation.png"), "我的预约", this);
